...
<template>
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="col-xs-12 form-inline group-left validateModal center-block  uploadin upload">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-default btn-confirm" @click="confirm" style="display: none">确认移除</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
...
var confirmUrl = action.rootPath + action.interface.whiteConfirmDelete
export default {
    props: ['modalProps']
    ,data (){
